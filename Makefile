...
OBJECTS = buffer.o buffer_reader.o packet.o table.o crc32.o mymemory.o server.o pt_error.o gc_malloc.o async_client.o sync_client.o eventhandler.o
...
pt_error.o : pt_error.c
	$(CC) $(CFLAGS) pt_error.c
